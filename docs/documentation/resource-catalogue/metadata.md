...
Open the collection
Look for the information button in the left-hand panel
Click the information button to view comprehensive metadata
...
Item-Level Metadata
Each individual item (scene) within a collection has its own metadata, accessible through the information button on the item card. This includes:
...
Look for the "self" link in the additional resources
This provides the JSON representation of the metadata
Can be used for programmatic access or integration with other tools
