...
Note, to test this workflow locally, you can hardcode a token into the CWL script, rather than setting it as `<<REPLACE>>` as is required by the workflow runner to replace this variable.
