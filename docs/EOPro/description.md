...
Key Workflow Scenarios supported are:

- Land Cover Change Detection: Enables users to visualize and analyze land cover transformations over time using satellite imagery.
- Water Quality Monitoring: Allows assessment of water quality parameters through spectral indices derived from geospatial data.
