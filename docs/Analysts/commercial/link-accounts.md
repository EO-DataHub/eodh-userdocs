# Linking Planet and Airbus accounts to the EODH

!!! info
    Users are able to associate their commercial data account tokens with their EODH account in the [workspaces](https://eodatahub.org.uk/workspaces) page as long as those providers are supported by the Hub. Airbus and Planet are currently supported. The process for each supported data provider, respectively, is outlined below.
