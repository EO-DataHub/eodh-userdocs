...
All workflows are registered to a specific workspace in which they were deployed. Therefore, to access workflows, you will need to specify the workspace you are trying to access within the URL, as follows: 

```bash
https://staging.eodatahub.org.uk/api/catalogue/stac/catalogs/user/catalogs/<workspace>/processes
```
...
Further guidance on updating access policies can be found [here](https://eodatahub.org.uk/docs/documentation/service-publishing/) in the Hub documentation.